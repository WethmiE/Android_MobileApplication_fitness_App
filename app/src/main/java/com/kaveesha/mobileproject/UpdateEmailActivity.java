...
public class UpdateEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdateEmail.setEnabled(false); //Make button disabled in the beginning until the using authenticate
        ...
        if(firebaseUser.equals("")){
            Toast.makeText(UpdateEmailActivity.this, "Something went to wrong! User's details not available", Toast.LENGTH_SHORT).show();
        } else{
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                //Disable EditText for password,button to verify user and enable Edittext for new Email and update email buttton
                                editTextNewEmail.setEnabled(true);
                                editTextPwd.setEnabled(false);
                                buttonVerifyUser.setEnabled(false);
                                buttonUpdateEmail.setEnabled(true);

                                //change the color of update email button
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.menu_refresh){
            ...
            Intent intent = new Intent(UpdateEmailActivity.this, Splash.class);
            ...
            Toast.makeText(UpdateEmailActivity.this, "Something went to wrong!", Toast.LENGTH_SHORT).show();
